...
if(isset($_SESSION['nome_usu_sessao'])){
			...
			echo "<a href='./cadastro.php?logout'>aqui.</a>";
		}else{
				echo "Seja bem vindo visitante, se deseja acessar o sistema <a href='./login.php'>clique aqui.</a>";
		}
...
<body>
   ...
   <Thead>
         <h2 align="center" style="font-family:verdana">Cadastro</h2>
		 <p>
.
</p>
		...
		<fieldset align="center"><!--Inicio - Tag mãe -->
			...
			<!--fieldset do campo senha -->
				<div class="dados">
				<label>CPF:</label>
				<input type="text" id="assunto" name="cpf" required />
				</div>
			</fieldset>
			<fieldset class="bloco">
