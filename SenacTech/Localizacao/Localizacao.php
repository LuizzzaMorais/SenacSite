...
if(isset($_SESSION['nome_usu_sessao'])){
			...
			echo "<a href='./Localizacao.php?logout'>aqui.</a>";
		}else{
...
<div>
<p align="center">
		<iframe id="mapa" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3453.7916150505043!2d-51.2210815848851!3d-30.042835681882874!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x951978567f17f28d%3A0x2c2c5272bacf4d3a!2sSenac%20Tech!5e0!3m2!1spt-BR!2sbr!4v1687531931333!5m2!1spt-BR!2sbr" width="1500" height="650" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
		<
		</div>
		<br>
		<br>
	<img hspace="95" align="left" src="img/mapa.png" width="40" height="40">
   <p class="contato">
   VENÂNCIO AIRES 93 CIDADE BAIXA - PORTO ALEGRE - RS CEP 90040-191<br>
   
   <br>
   <br>
   </p>
   <img hspace="95" align="left" src="img/relogio.png" width="40" height="40">
   <p class="contato">
   HORÁRIO DE FUNCIONAMENTO - DIAS ÚTEIS: 08:30 - 20:00<br>
   <BR>
   <BR>
   </p>
   <img hspace="95" align="left" src="img/wpp.png" width="40" height="40">
   <p class="contato">
   (51) 99315-9728 / (51) 98594-0071<br>
   <br>
   <br>
   </p>
   <img hspace="95" align="left" src="img/telefone.png" width="40" height="40">
   <p class="contato">
   (51) 3288-7750<br>
   <br>
   <br>
