...
if(isset($_SESSION['nome_usu_sessao'])){
			...
			echo "<a href='./TecInfo.php?logout'>aqui.</a>";
		}else{
...
Gostou da ideia de ser um profissional completo da área Administrativa? Venha para o curso Técnico em Administração do Senac-RS e mude de vida.<br><br>
   </p>
